...
class TaskNotificationService {
  ...
  Future<String> _getLocalTimeZone() async {
    try {
      ...
      try {
        ...
        print(
          'TaskNotificationService: Timezone $properTimeZone not found, using UTC',
        );
        return 'UTC';
      }
    } catch (e) {
      print(
        'TaskNotificationService: Could not determine timezone, using UTC: $e',
      );
      return 'UTC';
    }
  }
  ...
  void _onNotificationTapped(NotificationResponse notificationResponse) {
    ...
    if (payload != null) {
      print(
        'TaskNotificationService: Notification tapped with payload: $payload',
      );
  ...
  Future<void> _createNotificationChannels() async {
    ...
    try {
      ...
      const AndroidNotificationChannel taskDeadlineChannel =
  ...
  Future<void> _scheduleReliableNotifications(
    Task task,
    ...
    try {
      ...
      final preNotificationTime = scheduledDate.subtract(
      ...
      print(
        'TaskNotificationService: Scheduled $scheduledCount notification strategies for maximum reliability',
      );
    } catch (e) {
      print(
        'TaskNotificationService: Error scheduling reliable notifications: $e',
      );
    }
  }
  ...
  Future<void> _scheduleNotificationWithStrategy(
    ...
    final AndroidNotificationDetails androidNotificationDetails =
        AndroidNotificationDetails(
          ...
          ongoing: false,
          autoCancel:
              !isCritical, // Critical notifications stay until dismissed
          playSound: true,
          enableVibration: true,
          category:
              isCritical
          ...
          fullScreenIntent:
              isMain ||
              isCritical, // Full screen for main and critical notifications
          ...
          vibrationPattern:
              isCritical
                  ...
                  ? Int64List.fromList([
                    ...
                    100,
                    300,
                  ]) // Short pattern for pre-notification
    ...
    final String body = _createEnhancedNotificationBody(
      task,
      isMain,
      isPreNotification,
      isCritical,
    ...
    print(
      'TaskNotificationService: Scheduled ${scheduleMode.toString().split('.').last} notification (ID: $notificationId) for: ${scheduledDate}',
    );
  }

  /// Create enhanced notification body with more details
  String _createEnhancedNotificationBody(
    Task task,
    bool isMain, [
    bool isPreNotification = false,
    bool isCritical = false,
  ...
  Future<void> _verifyNotificationScheduled(
    int notificationId,
    String taskTitle,
  ) async {
    try {
      ...
      final bool isScheduled = pendingNotifications.any(
        (notification) => notification.id == notificationId,
      );

      if (isScheduled) {
        print(
          'TaskNotificationService: ✓ Verified notification scheduled for: $taskTitle',
        );
      } else {
        print(
          'TaskNotificationService: ⚠️ Warning: Notification not found in pending list for: $taskTitle',
        );
      }
    } catch (e) {
    ...
    try {
      const AndroidNotificationDetails androidNotificationDetails =
          AndroidNotificationDetails(
            ...
            'Task Deadlines',
            channelDescription:
                'Notifications for task due dates and deadlines',
            importance: Importance.max,
      ...
      print(
        'TaskNotificationService: Error showing immediate notification: $e',
      );
    }
  }
  ...
  Future<void> testNotificationScheduling() async {
    ...
    try {
      print(
        'TaskNotificationService: Starting enhanced test notification scheduling...',
      );
      ...
      print(
        'TaskNotificationService: Error scheduling enhanced test notifications: $e',
      );
    }
  }
  ...
  Future<void> rescheduleNotificationsAfterBoot() async {
    ...
    try {
      print(
        'TaskNotificationService: Rescheduling notifications after boot...',
      );
      ...
      print(
        'TaskNotificationService: Boot rescheduling complete. TaskNotificationIntegration should handle task rescheduling.',
      );
    } catch (e) {
      print(
        'TaskNotificationService: Error rescheduling notifications after boot: $e',
      );
    }
  }
  ...
  Future<void> _scheduleTestNotification(
    ...
    const AndroidNotificationDetails androidDetails =
        AndroidNotificationDetails(
          ...
          'Task Deadlines',
          channelDescription:
              'Test notification with different scheduling strategies',
          importance: Importance.max,
          priority: Priority.high,
          icon: '@mipmap/ic_launcher',
