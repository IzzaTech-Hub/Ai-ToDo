...
class BootNotificationService {
  static final BootNotificationService _instance =
      BootNotificationService._internal();
  factory BootNotificationService() => _instance;
  BootNotificationService._internal();

  final TaskNotificationIntegration _notificationIntegration =
      TaskNotificationIntegration();
  ...
  Future<void> handleAppUpdate() async {
    ...
    try {
      ...
      print(
        'BootNotificationService: App update handling completed successfully',
      );
    } catch (e) {
  ...
  Future<void> checkAndRescheduleOnLaunch() async {
    ...
    try {
      ...
      print(
        'BootNotificationService: Error checking/rescheduling on launch: $e',
      );
    }
  }
